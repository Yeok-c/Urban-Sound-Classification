...
for model_type in model_types:
    for train_index, test_index in kf.split(folds):
        ...
        log_dir= model_type + "logs/fit/" + folds[test_index][0]
        ...
        cm.figure_.savefig(model_type + 'conf_mat_' + str(test_index) + '_acc_' + str(accuracy_score(y_true, y_pred)) + '.png',dpi=1000)    
